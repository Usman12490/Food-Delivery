      ...
      <div className="container">
            ...
            <div className="step">
              ...
              <div className="payments">
                ...
                <div className="details">
                  ...
                  <span>Shipping:</span>
                  <span>Rs. {getTotalCartAmount() === 0 ? 0 : 200}</span>
                  <span>Total</span>
                  <span>Rs. {getTotalCartAmount() === 0 ? 0 : getTotalCartAmount() + 200}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="card checkout">
          <div className="footer">
            <label className="price">Rs. {getTotalCartAmount() === 0 ? 0 : getTotalCartAmount() + 200}</label>
